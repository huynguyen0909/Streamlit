...
if os.path.exists('./figures/' + str(option) + '/stock_' + str(option) + end_date + '.png') \
  ...
  plt.title(company, fontsize=50)
  plt.xlabel('Days', fontsize=30)
  plt.ylabel('Close Price USD ($)', fontsize=30)
  plt.plot(test_data['Close'],color='navy',linewidth = '20.5')
  ...
  plt.figure(figsize=(40,20))
  plt.title(company + ' - Prediction of the next week', fontsize=50)
  plt.xlabel('Days', fontsize=30)
  plt.ylabel('Close Price USD ($)', fontsize=30)
  plt.plot(week, color='red', label='Prediction', linewidth = '20.5')
